      ...
      <section className="section-card-buy">
        <div className="section-card-buy-div">
          ...
          <div className="section-card-buy-text">
            ...
            <p>
              lfkneasowifnoewnfowefnoiewnfoiewnfoiewnfoiwenfioewnfoiewfnoiefnoi
            </p>
          </div>
        </div>
      </section>
      <section className="container-md d-flex flex-column align-items-center p-3">
        <h3>Titulo de la seccion de cartas</h3>
        <p style={{ fontSize: "14px", marginBottom: "0" }}>naoiufenofneowifnoiwenfoiuewnfoewifnewopufnepfouinefoiewowneif</p>
